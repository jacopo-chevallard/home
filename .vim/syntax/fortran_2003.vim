...
" Version:	0.88 -- with F2003 syntax added by Joe Krahn
...
" Also set free/fixed format by file hints: (Joe Krahn)
  if b:fortran_retype =~ '\<fortran_free_source\>'
    let b:fortran_free_source = 1
  elseif b:fortran_retype =~ '\<fortran_fixed_source\>'
...
"=====================================================
" F2003
syn keyword fortran2003Intrinsic move_alloc random_number random_seed
syn keyword fortran2003Intrinsic command_argument_count get_command get_command_argument
syn keyword fortran2003Intrinsic get_environment_variable is_iostat_end is_iostat_eor
syn keyword fortran2003Intrinsic spread cshift new_line
syn keyword fortran2003Intrinsic same_type_as extends_type_of

syn keyword fortran2003UnitHeader import
syn keyword fortran2003Type non_intrinsic
syn keyword fortran2003Type value asynchronous volatile protected bind
syn keyword fortran2003Type pass nopass deferred non_overridable generic final

syn match fortran2003UnitHeader	"\<abstract\s*interface\>"
syn match fortran2003UnitHeader "\<enum\s*,\s*bind\s*(\s*c\s*)"
syn match fortran2003UnitHeader "\<end\s*enum"
syn keyword fortran2003Type enumerator

" All ISO-C-Binding types:
syn keyword fortran2003Type c_int c_short c_long c_long_long c_signed_char c_size_t
syn keyword fortran2003Type c_int8_t c_int16_t c_int32_t c_int64_t
syn keyword fortran2003Type c_int_least8_t c_int_least16_t c_int_least32_t
syn keyword fortran2003Type c_int_least64_t c_int_fast8_t c_int_fast16_t
syn keyword fortran2003Type c_int_fast32_t c_int_fast64_t c_intmax_t c_intptr_t
syn keyword fortran2003Type c_float c_double c_long_double c_float_complex
syn keyword fortran2003Type c_double_complex c_long_double_complex c_bool c_char
syn keyword fortran2003Type c_ptr c_funptr

syn keyword fortran2003Intrinsic iso_c_binding c_funloc c_loc c_funptr c_associated
syn keyword fortran2003Intrinsic c_null_ptr c_null_funptr c_f_pointer
syn keyword fortran2003Intrinsic c_null_char c_alert c_backspace c_form_feed c_new_line
syn keyword fortran2003Intrinsic c_carriage_return c_horizontal_tab c_vertical_tab
"=====================================================
...
if version >= 508 || !exists("did_fortran_syn_inits")
  ...
  if ( b:fortran_dialect == "elf" || b:fortran_dialect == "F" )
    ...
    HiLink fortran2003Intrinsic	fortranObsolete
    HiLink fortran2003Type	fortranObsolete
    HiLink fortran2003Structure	fortranObsolete
    HiLink fortran2003UnitHeader	fortranObsolete
  else
    ...
    HiLink fortran2003Intrinsic	Function
    HiLink fortran2003Type	fortranType
    HiLink fortran2003Structure	fortranStructure
    HiLink fortran2003UnitHeader	fortranUnitHeader
  endif
